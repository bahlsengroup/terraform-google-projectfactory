    ...
    custom_roles = {
      "appengine.applicationsCreator" = {
        ...
        project_iam_policy_members = [
          "group:customer.project-role@bahlsen.com",
        ]
      }
    }
    ```
          ...
          iam_policy = [
            {
              ...
              members = [
                "group:project-role@bahlsen.com",
              ]
            }
          ]
...
variable "essential_contacts" {
  description = <<-EOD
    ...
    **Remark:** The module will enable the essential contacts API automatically once one contact is configured.
    ...
    ```
    essential_contacts = {
      "some-group-mailing-list@bahlsen.com" = {
        language   = "en"
        categories = ["ALL"]
      }
      "some-other-group-list@bahlsen.com" = {
        language   = "en"
        categories = [
          "SUSPENSION",
          "TECHNICAL"
...
variable "workload_identity_pool_attribute_condition" {
  description = <<-EOD
    ...
    workflows from your organisation.
  EOD
